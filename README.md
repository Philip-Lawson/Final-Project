...
See the [implementation guide](http://github.com/Philip-Lawson/Final-Project/ImplementationGuide.md) for more information on implementing the classes needed.
